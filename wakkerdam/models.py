...
class WolfVote(models.Model):
	wolfgame = models.ForeignKey(Game, related_name = 'WolfVotes')
	wolfvoter = models.ForeignKey(Player, related_name = 'Wolfvoters')
	wolfvotee = models.ForeignKey(Player, related_name = 'Wolfvotees')
	olifantround = models.IntegerField(default=1)
